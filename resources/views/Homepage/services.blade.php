            ...
            <div class="col-md-4 mb-5">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Registered student are the only one who can use this platform. The main
                            function of the system is to help student to complaint easier so better be honest and careful.
            ...
            <div class="col-md-4 mb-5">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text"> Teacher is the second parents of the students so please be fair to the
            ...
            <div class="col-md-4 mb-5">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text"> Your friend will also access the system and complain for you because Truly
                            great friends are hard to find, difficult to leave, and impossible to forget. but also don't
                            forget that friends will become your enemy one day. Choose properly. Be a helpful friend.
