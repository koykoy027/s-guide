...
@section('content')
    ...
    {{-- COUNSILOR SECTION --}}
    <section class="row justify-content-center align-items-center" style="display: flex" id="counsilor">
        <div class="col-xl-10">
            <div class="card">
                <div class="row">
                    <div class="col-md">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md">
                                        <input placeholder="Enter School code" type="text"
                                            ...
                                            name="school_code" value="{{ old('school_code') }}" required
                                            autocomplete="school_code" autofocus>
                                        @error('school_code')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
    ...
    {{-- STUDENT SECTION --}}
    {{-- <section class="row justify-content-center align-items-center" id="student" style="display: none">
        <div class="col-xl-10">
            <div class="card">
                <div class="row">
                        ...
                        <div class="card-body p-lg-5 text-black">
                            ...
                            <form class="col-lg p-5 shadow" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md">
                                        <input placeholder="Enter Student number" type="text"
                                            class="form-control @error('employee_number') is-invalid @enderror"
                                            name="employee_number" value="{{ old('employee_number') }}" required
                                            autocomplete="employee_number" autofocus>
                                        @error('employee_number')
                                ...
                                <div class="d-flex justify-content-between">
                                    <a class="mt-3" onClick="btnRegAsStudent()" type="button">Register as Student</a>
